...
test polls `show interfaces description` once per second for up to 5 minutes and
...
interface reverted to its baseline admin/oper state within the 5-minute revert

...
test polls `show interfaces description` once per second for up to 3 minutes and
...
interface reverted to its baseline admin/oper state within the 3-minute revert
